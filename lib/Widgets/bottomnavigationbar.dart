          ...
          child: Row(
            ...
            children: [
              GestureDetector(
                ...
                size: 30,
                color:index_color==0? Color.fromARGB(255, 47, 125, 121):Colors.grey, ),
              ),
              GestureDetector(
                onTap: (){
                  setState(() {
                ...
                child: Icon(Icons.bar_chart_outlined,
                  size: 30,
                  color:  index_color==1? Color.fromARGB(255, 47, 125, 121):Colors.grey),
              ),
              SizedBox(width: 20,),
              GestureDetector(
                onTap: (){
                ...
                child: Icon(Icons.account_balance_wallet_outlined,
                  size: 30,
                  color: index_color==2? Color.fromARGB(255, 47, 125, 121):Colors.grey),
              ),
              GestureDetector(
                onTap: (){
                  setState(() {
                ...
                child: Icon(Icons.person_outlined,
                  size: 30,
                  color: index_color==3? Color.fromARGB(255, 47, 125, 121):Colors.grey),
              ),
